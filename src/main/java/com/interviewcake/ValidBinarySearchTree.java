...
public class ValidBinarySearchTree {
	...
	private static boolean isValidBST(BinaryTreeNode root, int lowerBound, int upperBound) {
		...
		return isValidBST(root.left, lowerBound, root.value) && isValidBST(root.right, root.value, upperBound);
	}
