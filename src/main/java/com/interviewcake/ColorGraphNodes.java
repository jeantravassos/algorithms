...
public class ColorGraphNodes {
	...
	public static void colorGraph(GraphNode[] graph, String[] colors) {
		...
		for (GraphNode node : graph) {
			...
			if (neighbors.contains(node)) {
				throw new IllegalArgumentException("Not possible legal coloring for node with loop");
			}
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(ColorGraphNodes.class);
